...
def main():
    ...
    m = 25000
    n = 384
    XandYtrain = genfromtxt('F:/Git_file/data-mining/hw1/data/train.csv',
                            delimiter=',',
                            dtype='float',
                            skip_header=True)
    ...
    '''
    XtestWithID = genfromtxt('F:/Git_file/data-mining/hw1/data/test.csv',
                             delimiter=',',
                             dtype='float',
                             skip_header=True)
    ...
    #theta = loadtxt("F:/Git_file/data-mining/hw1/data/theta_py_iter_150k.txt",
    #               dtype='float').reshape((2 * n + 1, 1))
    #theta = zeros((Xtrain.shape[1]+1, 1))
    print "Done!"

    # training
    [J, theta] = train_lr_gd('linear', Xtrain, ytrain, alpha, alambda,
                                    num_iters)
